...
export const aboutData = {
  ...
  values: [
    ...
    { title: "Innovation", description: "Embracing cutting-edge environmental solutions" },
    { title: "Sustainability", description: "Committed to long-term environmental health" }
  ],
  stats: [
...
export const projectsData = [
  {
    id: 1,
    title: "Metro Rail EIA Study",
    client: "State Transport Authority",
    category: "Infrastructure",
    description: "Comprehensive EIA for 45km metro rail project including baseline studies, impact assessment, and environmental management plan.",
    image: "https://images.unsplash.com/photo-1554672723-d42a16e533db?w=800&q=80",
    results: ["Zero delays due to environmental clearance", "95% stakeholder approval", "Sustainable design implementation"]
  },
  {
    id: 2,
    title: "Industrial Park Sustainability",
    client: "Major Manufacturing Group",
    category: "Industrial",
    description: "Developed comprehensive sustainability framework for 500-acre industrial park achieving LEED Platinum certification.",
    image: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=800&q=80",
    results: ["40% reduction in carbon emissions", "LEED Platinum achieved", "30% water conservation"]
  },
  {
    id: 3,
    ...
    category: "Energy",
    description: "Environmental clearance and monitoring for 100MW solar power facility with wildlife conservation measures.",
    image: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80",
    results: ["Fast-track environmental clearance", "Zero wildlife incidents", "Community benefit programs"]
  },
  {
    id: 4,
    title: "Smart City Environmental Planning",
    client: "Municipal Corporation",
    category: "Urban Development",
    description: "Integrated environmental planning for smart city project covering waste management, green spaces, and air quality.",
    image: "https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=800&q=80",
    results: ["20% improvement in air quality", "Zero-waste model implemented", "50+ green spaces created"]
  }
];
